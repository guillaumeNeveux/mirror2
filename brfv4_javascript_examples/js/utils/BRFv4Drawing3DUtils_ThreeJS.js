(function() {
	...
	var t3d		= brfv4.example.drawing3d.t3d;	// ThreeJS namespace.
	var dom		= brfv4.example.dom;			// ... e.g. the DOM handling.

	if(!t3d) {
		brfv4.example.drawing3d.t3d = {};
	}
	...
	t3d.setup = function(canvas) {
		...
		t3d.updateLayout(dom.elementWidth, dom.elementHeight);
	};
